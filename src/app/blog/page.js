...
const Blog = () => {
  ...
  return (
    <>
      <div className="mt-[70px] max-sm:mt-[48px] relative">
        ...
        <div className="inline-flex max-sm:flex-col items-start rounded-[40px] bg-[#010D50] mb-[92px] max-sm:mb-[80px] mx-[157px] max-sm:mx-4 max-sm:w-[358px]">
          <Image
            src="/Images/card.jpg"
            alt="Blog Image"
            width={586}
