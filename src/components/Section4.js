...
const Section4 = () => {
    return (
      <div className="flex max-sm:flex-col sm:justify-between items-center  h-[513px] max-sm:h-[609px] flex-shrink-0 bg-[#0328EE] sm:px-[133px] sm:mt-[116px] sm:mb-[200px] max-sm:mb-[120px] max-sm:pt-[40px] ">
