  ...
  return (
    <section className="portfolio-section pb-[80px]">
      <div className="flex-col justify-center items-center text-center pt-[174px] max-sm:pt-[65px] pb-[80px] max-sm:pl-[16px] max-sm:text-start">
        ...
        <h2 className={`${TEXT_STYLES.sectionTitle} text-[42px] max-sm:text-[28px] leading-[55.02px] max-sm:leading-[36px] pb-[15px] max-sm:w-[273px]`}>
          Build your crypto portfolio
        </h2>
        <p className={`${TEXT_STYLES.description} text-[18px] max-sm:text-[16px] leading-[32.004px] max-sm:leading-[26px] max-sm:w-[314px] w-[496px] inline-block relative`}>
          {LOREM_TEXT}
        </p>
      </div>
